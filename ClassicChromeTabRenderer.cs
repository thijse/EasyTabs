...
namespace EasyTabs
{
	...
	public class ClassicChromeTabRenderer : BaseTabRenderer
	{
        /// <summary>
        /// A Chrome-specific right-side tab image that allows the separation between inactive tabs to be more clearly defined.
        /// </summary>
	    protected Image _inactiveRightSideShadowImage = Resources.ClassicChromeInactiveRightShadow;
		...
		public ClassicChromeTabRenderer(TitleBarTabs parentWindow)
			: base(parentWindow)
		{
			// Initialize the various images to use during rendering
			_activeLeftSideImage        = Resources.ClassicChromeLeft;
			_activeRightSideImage       = Resources.ClassicChromeRight;
			_activeCenterImage          = Resources.ClassicChromeCenter;
			_inactiveLeftSideImage      = Resources.ClassicChromeInactiveLeft;
			_inactiveRightSideImage     = Resources.ClassicChromeInactiveRight;
			_inactiveCenterImage        = Resources.ClassicChromeInactiveCenter;
			_closeButtonImage           = Resources.ClassicChromeClose;
			_closeButtonHoverImage      = Resources.ClassicChromeCloseHover;
			_background                 = Resources.ClassicChromeBackground;
			_addButtonImage             = new Bitmap(Resources.ClassicChromeAdd);
			_addButtonHoverImage        = new Bitmap(Resources.ClassicChromeAddHover);
